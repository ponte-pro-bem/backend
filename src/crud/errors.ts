...
export class CustomError extends Error {
  ...
  static BAD_PASSWORD = `Senha deve ter pelo menos ${MAX_PASSWORD_LENGTH} caracteres.`;
  ...
  static CAMPAIGN_NOT_FOUND = "Campanha não encontrada.";
  static TAG_ALREADY_EXISTS = "Categoria já existe.";
}
